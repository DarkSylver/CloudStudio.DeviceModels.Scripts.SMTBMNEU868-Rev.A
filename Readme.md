...
# Parsing Script – SMTBMNEU868 - Rev. A

This **Parsing** script is designed for the **SMTBMNEU868** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – SMTBMNEU868 Rev. A

Este script de **Parsing** está diseñado para el modelo **SMTBMNEU868** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
